...
class SubscriptionHelper
{
    ...
    public static function start_monthly_bronze_trial_subscription($customer_id, $user_id, $subPlan)
    {
        try {
            $stripeData = null;
            $current_period_start = date("Y-m-d H:i:s");
    ...
    public static function capture_monthly_bronze_pending_fees($customer_id, $user_id, $user_name, $subPlan, $stripe)
    {
        $totalAmount = $subPlan->amount;
        $daysInMonth = date('t');
        $currentDay = date('j');
    ...
    public static function start_monthly_bronze_subscription($customer_id, $user_id, $subPlan, $stripe)
    {
        try {
            $stripeData = null;
            $millisecondsDate = strtotime(date("Y-m-") . "01");
    ...
    public static function renew_monthly_bronze_subscription($subscriptionDetail, $user_id, $subPlan, $stripe)
    {
        try {
            $stripeData = null;
            $millisecondsDate = strtotime(date("Y-m-") . "01");

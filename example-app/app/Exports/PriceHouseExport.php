...
//print_r(json_encode($data));
            ...
            if (isset($data['Reports']) && is_array($data['Reports']) && !empty($data['Reports'])) {
                ...
                $formattedData[] = [
                    ...
                    $subjectProperty['StreetAddress'] ?? null,
                    $subjectProperty['County'] ?? null,
                    $subjectProperty['State'] ?? null,
                    $subjectProperty['OwnerNames'] ?? null,
                    $subjectProperty['SellerName'] ?? null,
                    $subjectProperty['BuyerName'] ?? null,
                    $subjectProperty['SaleDate'] ?? null,
                    $subjectProperty['RecordingDate'] ?? null,
                    $subjectProperty['SalePrice'] ?? null,
                    $subjectProperty['ListingStatus'] ?? null,

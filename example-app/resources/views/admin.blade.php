                                    ...
                                    <tbody>
                                      ...
                                      @foreach($data as $user)
                                        ...
                                        <tr>
                                            <td>{{ $user['name']}}</td>
                                            <td>{{ $user['email']}}</td>
                                            <td><?php if($user['is_verified'] == '1') { echo 'Yes';  } else { echo 'No'; } ?> </td>
                                            <td><?php if($user['is_subscribed'] == '1') { echo 'Yes';  } else { echo 'No'; } ?> </td>
                                            <td>{{ $user['created_at']}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>

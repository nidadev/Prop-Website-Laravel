...
<img src="{{ $logo }}" alt="Company Logo" width="245px" height="38"> <!-- Replace with actual logo URL -->
    ...
    <table>
        ...
        if($acre_real_1 > 0)
        <tr>
            <td> {{number_format($acre_real_1,1)}}</td>
            <td> ${{ $list_p_real_1}}</td>
            <td> {{ $real_price_per_1}} </td>
            <td> {{ $dis_zill}} miles</td>
            <td> {{$real_cty_1}}</td>
            <td> {{$real_coun_1}}</td>
            <td> <a href="{{$href_real_1}}">Realtor</a></td>
        </tr>
        @endif
        @if($acre_red)
        <tr>
        ...
        <tr>
            <td> {{ $acre_zll_1}}</td>
            <td> ${{ $list_p_zll_1}}</td>
            <td> {{ $zll_price_per_1}} </td>
            <td> {{ $dis_zill }} miles</td>
            <td> {{$zll_cty_1}}</td>
            <td> {{$zll_coun_1}}</td>
            <td> <a href="https://zillow.com/homedetails/{{$href_zll_1}}_zpid">Zillow</a></td>
        </tr>
        <tr>
            <td> {{$acre_zll_2}}</td>
            <td> ${{ $list_p_zll_2}}</td>
            <td> {{ $zll_price_per_2}} </td>
            <td> {{ $dis_zill }} miles</td>
            <td> {{$zll_cty_2}}</td>
            <td> {{$zll_coun_2}}</td>
            <td> <a href="https://zillow.com/homedetails/{{$href_zll_2}}_zpid">Zillow</a></td>
        </tr>
        <tr>
            <td> {{$acre_zll_3}}</td>
            <td> ${{ $list_p_zll_3}}</td>
            <td> {{ $zll_price_per_3}} </td>
            <td> {{ $dis_zill }} miles</td>
            <td> {{$zll_cty_3}}</td>
            <td> {{$zll_coun_3}}</td>
            <td> <a href="https://zillow.com/homedetails/{{$href_zll_3}}_zpid">Zillow</a></td>
        </tr>
    ...
    <table>
        ...
        <tr>
            <td> {{$acre_zll_sold_1}}</td>
            <td> ${{ $list_p_zll_sold_1}}</td>
            <td> {{ $zll_sold_price_per_1}} </td>
            <td> {{ $dis_zill }} miles</td>
            <td> {{$zll_sold_cty_1}}</td>
            <td> {{$zll_sold_coun_1}}</td>
            <td> <a href="https://zillow.com/homedetails/{{$href_zll_sold_1}}_zpid">Zillow</a></td>
        </tr>
        <tr>
        <td> {{$acre_zll_sold_2}}</td>
            <td> ${{ $list_p_zll_sold_2}}</td>
            <td> {{ $zll_sold_price_per_2}} </td>
            <td> {{ $dis_zill }} miles</td>
            <td> {{$zll_sold_cty_2}}</td>
            <td> {{$zll_sold_coun_2}}</td>
            <td> <a href="https://zillow.com/homedetails/{{$href_zll_sold_2}}_zpid">Zillow</a></td>
           </tr>

        <tr>
        <td> {{$acre_zll_sold_3}}</td>
            <td> ${{ $list_p_zll_sold_3}}</td>
            <td> {{ $zll_sold_price_per_3}} </td>
            <td> {{ $dis_zill }} miles</td>
            <td> {{$zll_sold_cty_3}}</td>
            <td> {{$zll_sold_coun_3}}</td>
            <td> <a href="https://zillow.com/homedetails/{{$href_zll_sold_3}}_zpid">Zillow</a></td>
       </tr>
        <tr>
            <td> {{ number_format($acre_real_sold,1)}}</td>
            <td> ${{ $list_p_real_sold}}</td>
            <td> {{ $real_sold_price_per}} </td>
            <td> {{ $dis_zill }} miles</td>
            <td> {{$real_sold_cty}}</td>
            <td> {{$real_sold_coun}}</td>
